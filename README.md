...
Para el desarrollo de esta evaluación, utilizamos herramientas de IA (como GitHub Copilot/Modelos LLM) para:

1.  **Generación de Estructura**: Apoyo en la creación de Hooks personalizados (`useTodoManager`) para separar la lógica de la vista.
2.  **Resolución de Problemas Técnicos**:
    - Implementación correcta del guardado de imágenes en iOS/Android (solución de permisos y rutas).
    - Configuración de `expo-media-library` para guardar copias en la galería.
3.  **Optimización de Código**: Mejoras en la navegación (`router.dismissAll`) y manejo de errores en operaciones asíncronas.
...
https://youtu.be/xoX4Mt390c8

---

**Estudiante**: Camilo Pérez García
**Fecha**: Octubre 2025
